module github.com/pschlump/pluto/hash_tab_bt
...
require (
	...
	github.com/pschlump/pluto/binary_tree v0.0.3
...
require (
	...
	github.com/pschlump/dbgo v1.0.5 // indirect
	github.com/pschlump/filelib v1.0.6 // indirect
	github.com/pschlump/json v0.0.0-20180316172947-0d2e6a308e08 // indirect
	github.com/pschlump/pluto/g_lib v0.0.3 // indirect
	github.com/pschlump/pluto/stack v0.0.3 // indirect
...
replace github.com/pschlump/pluto/binary_tree => ../binary_tree
