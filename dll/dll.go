...
This version of the DLL is not suitable for concurrent usage; ../dll_ts has mutex
...
// To iterate over a list (where l is a *dll.Dll):
//
...
// dll_ts package.  This implementation is not safe for concurrent use.
func (ns *Dll[T]) Lock() {}
